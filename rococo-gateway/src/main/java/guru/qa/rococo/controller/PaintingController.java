...
public class PaintingController {
    ...
    @PostMapping()
    public PaintingJson addPainting(@AuthenticationPrincipal Jwt principal, @RequestBody PaintingJson paintingJson) {
        return paintingService.addPainting(paintingJson);
    }

    @PatchMapping()
    public PaintingJson editPainting(@AuthenticationPrincipal Jwt principal, @RequestBody PaintingJson paintingJson) {
