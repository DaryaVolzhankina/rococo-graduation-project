...
public class MuseumController {
    ...
    @PostMapping()
    public MuseumJson addMuseum(@AuthenticationPrincipal Jwt principal, @RequestBody MuseumJson museum) {
        return museumService.addMuseum(museum);
    }

    @PatchMapping()
    public MuseumJson editMuseum(@AuthenticationPrincipal Jwt principal, @RequestBody MuseumJson museum) {
        return museumService.editMuseum(museum);
    }
}
